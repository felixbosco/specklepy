                ...
                if cube.ndim == 2:
                    ...
                    for f in trange(cube.shape[0], desc='Updating frame'):
                        ...
                        try:
                            ...
                            logger.warning(f"Unable to apply flat field correction to file {file!r}. Reason may be "
                                           f"that the sub-window covered by the master flat is smaller than the image.")
                            logger.warning(e)
                        hdu_list.flush()

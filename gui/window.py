...
class Window(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.setWindowTitle('GuiApplication')
        self.setWindowIcon(QtGui.QIcon('source/img/telescope.png'))

        # Menu bar
        mainMenu = self.menuBar()
        self.create_dropdown(mainMenu, '&File', [{'text': 'New window', 'function': self.__init__, 'shortcut': 'Ctrl+Shift+N'},
                                                 {'text': 'Open', 'function': self.do_nothing, 'shortcut': 'Ctrl+O'},
                                                 {'text': 'Settings', 'function': self.settings},
                                                 {'text': 'Quit', 'function': self.close_application, 'shortcut': 'Ctrl+Q'}])
        self.create_dropdown(mainMenu, '&Edit', [{'text': 'Undo', 'function': self.do_nothing, 'status_tip': 'Do nothing'},
                                                 {'text': 'Redo', 'function': self.do_nothing, 'status_tip': 'Do nothing'}])
        self.create_dropdown(mainMenu, '&View', [{'text': 'Increase font size', 'function': self.do_nothing, 'shortcut': 'Ctrl++'},
                                                 {'text': 'Decrease font size', 'function': self.do_nothing, 'shortcut': 'Ctrl+-'}])
        self.create_dropdown(mainMenu, '&Help', [{'text': 'Call help', 'function': self.do_nothing, 'shortcut': 'Ctrl+H'}])
